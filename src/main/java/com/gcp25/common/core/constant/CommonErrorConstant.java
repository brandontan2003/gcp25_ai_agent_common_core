...
public class CommonErrorConstant {
    ...
    public static final String API_EXECUTION_ERROR_CODE = "API_EXECUTION_ERROR";
    public static final String API_EXECUTION_ERROR_DESC = "We’re having trouble reaching our partner service. Please try again shortly.";
    public static final String INTERNAL_SERVER_ERROR_CODE = "INTERNAL_SERVER_ERROR";
    public static final String INTERNAL_SERVER_ERROR_DESC = "Something went wrong, please try again later.";
